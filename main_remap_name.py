...
# Description:
# ==========
# Renames the select data and ensure all the internal and external links
# still work within a project directory.
#
# ==========
# Script usage:
# ==========
...
#     - Set the inputs where remap_rename() is called in the file. It takes
# new name for the first argument, 'GROUP' for the second argument, and the
# project path and script path for the next 2 arguments.
#     - Click 'Run Script' on the text editor panel.
# - MESH:
#     - Select the object in the source file.
#     - Open the script in the internal text editor.
#     - Set the inputs where remap_rename() is called in the file. It takes
# the new name for the first argument, 'MESH' for the second argument,
# and the project path and script path for the next 2 arguments.
#     - Click 'Run Script' on the text editor panel.
# - MATERIAL:
...
#     - Open the script in the internal text editor.
#     - Set the inputs where remap_rename() is called in the file. It takes
# the new name for the first argument, 'MATERIAL' for the second argument,
# and the project path and script path for the next 2 arguments.
#     - Click 'Run Script' on the text editor panel.
#
remap_name(
